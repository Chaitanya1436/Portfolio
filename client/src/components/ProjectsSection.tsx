  ...
  const projects = [
    {
      ...
      description:
        "An easy-to-use video call platform where user matched on random intrests or specific intrests based on the user driven custom words",
      technologies: ["WebRTC", "Socket.io", "TURN", "React", "NAT"],
