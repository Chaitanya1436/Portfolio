...
const SkillsSection = () => {
  ...
  const skills = [
    {
      name: "Java",
      icon: "/Portfolio/my_images/java_icon.png", // image URL for custom icon
      tagline: "My main coding language, I use it everywhere",
      bgColor: "",
    },
    {
      name: "AWS",
      icon: "/Portfolio/my_images/AWS_icon.png", // React icon component from lucide-react
      tagline: "Learned how to deploy and scale stuff in college level",
      bgColor: "0",
    },
    {
      name: "Python",
      icon: "/Portfolio/my_images/python_icon.png",
      tagline: "My go-to for AI/ML and quick experiments",
      bgColor: "",
    },
    {
      name: "MicroSoft Azure",
      icon: "/Portfolio/my_images/microsoft_icon.png",
      tagline: "Explored AI and cloud integrations here",
      bgColor: "",
    },
    {
      name: "DSA",
      icon: "/Portfolio/my_images/DSA_icon.png",
      tagline: "Keeps me sharp for problem-solving and interviews",
      bgColor: "",
    },
    {
      name: "LeetCode",
      icon: "/Portfolio/my_images/leetcode_icon.png",
      tagline: "My gym for coding workouts",
      bgColor: "",
    },
    {
      name: "React",
      icon: "/Portfolio/my_images/react_icon.png",
      tagline: "Where I build cool, interactive web apps (learning)",
      bgColor: "",
    },
    {
      name: "CSS",
      icon: "/Portfolio/my_images/css_icon.png",
      tagline: "I make pages look less boring with this",
      bgColor: "",
    },
    {
      name: "Bootstrap",
      icon: "/Portfolio/my_images/Bootstrap.png",
      tagline: "Helps me style faster",
      bgColor: "",
    },
    {
      name: "Docker",
      icon: "/Portfolio/my_images/docker.png",
      tagline: "I containerize applications",
      bgColor: "",
    },
     {
      name: "Node.js",
      icon: "/Portfolio/my_images/nodejs_icon.png",
      tagline: "Used it to build some backend systems",
      bgColor: "",
    },
    {
      name: "VS Code",
      icon: "/Portfolio/my_images/VS_code_icon.png",
      tagline: "My everyday coding buddy",
      bgColor: "",
    },
    {
      name: "SQL",
      icon: "/Portfolio/my_images/SQL_icon.png",
      tagline: "Pretty fun, I hate playing with data here",
      bgColor: "",
    },
    {
      name: "GitHub",
      icon: "/Portfolio/my_images/github_icon.png",
      tagline: "My coding diary, where all projects live",
      bgColor: "",
    },
    {
      name: "HTML 5",
      icon: "/Portfolio/my_images/html5_icon.png",
      tagline: "The first thing I learned while building websites",
      bgColor: "",
    },
    {
      name: "Java Script",
      icon: "/Portfolio/my_images/JS_icon.png",
      tagline: "I know the basics, still leveling up",
      bgColor: "",
    },
    {
      name: "Postman",
      icon: "/Portfolio/my_images/postman.png",
      tagline: "My coding diary, where all projects live",
      bgColor: "",
    },
    {
      name: "REST API",
      icon: "/Portfolio/my_images/API.png",
